...
@section('title', getTranslatedWords('categories'))
@section('css')
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ getTranslatedWords('home') }} /</span>
            {{ getTranslatedWords('categories') }}</h4>
        ...
        <div class="card">
            ...
            @endcan
            {{-- <h5 class="card-header">{{ getTranslatedWords('categories') }}</h5>--}}
    ...
    <div class="modal fade" id="delete" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('categories.destroy', 0) }}">
                    @csrf
                    @method('delete')
