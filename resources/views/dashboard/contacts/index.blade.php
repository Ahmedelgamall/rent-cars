...
@section('title', getTranslatedWords('contacts'))
@section('css')
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ getTranslatedWords('home') }} /</span>
            {{ getTranslatedWords('contacts') }}</h4>
        <!-- Basic Bootstrap Table -->
        <div class="card">

            {{-- <h5 class="card-header">{{ getTranslatedWords('contacts') }}</h5> --}}
                ...
                <table class="table" id="datatables">
                    <thead>
                        <tr>
                            ...
                            <th>{{ getTranslatedWords('message') }}</th>
    ...
    <div class="modal fade" id="delete" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('contacts.destroy', 0) }}">
                    @csrf
                    @method('delete')
    ...
    <div class="modal fade" id="message" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">{{ getTranslatedWords('problem') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">
                    <div class="form-group">
                        <textarea class="form-control" name="" readonly id="" cols="30" rows="10">
                                </textarea>
                    </div>
                </div>
