...
@section('title', getTranslatedWords('add why choose us element'))
@section('css')
...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ getTranslatedWords('home') }} /</span> {{ getTranslatedWords('add why choose us element') }}</h4>

    <div class="row">
        <div class="col-md-12">

            <div class="card mb-4">
                <h5 class="card-header">{{ getTranslatedWords('add why choose us element') }}</h5>
                <!-- Account -->

                <hr class="my-0" />
                <div class="card-body">
                    <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('why-us.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                @component('components.input_trans', [
                                    'type' => 'textarea',
                                    'label' => getTranslatedWords(word: 'description'),
                                    'required' => 'true',
                                ])
                                text
                                @endcomponent
